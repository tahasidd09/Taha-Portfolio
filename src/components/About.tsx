  ...
  return (
    <div className="relative flex items-center justify-center h-screen">
      <div className="text-white px-6 md:px-12">
        <h2 className="text-center text-xl md:text-3xl font-bold mb-20 mt-0">Hi, My name is Taha Siddiqui</h2>
            ...
            <div className="bg-transparent rounded-lg shadow-lg px-5 py-6 sm:px-6 my-10 w-full max-w-3xl mx-auto border blur-background2 mt-0">
                ...
                <div className="space-y-6">
                    <p className="text-gray-200">
                         I am a 19 year old developer who started off as self-taught then went to GIAIC to study Computer Science .
                        I am in my second year at Formen collage and have been coding for 3 years now. I code every single day and I enjoy learning new technologies, languages, and experiencing working with new
